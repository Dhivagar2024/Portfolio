                ...
                <div className="row justify-content-center bg-info">
                    <div className="col-lg-10" id="back">
                        ...
                        <div className="text-center text-light" id="back-text">
                            <h1>Hi! There, I am Dhivagaran</h1>
            ...
            <div class="container-lg">
                <div class="row justify-content-center align-item-center">
                    <div class="col-md-5 text-center text-md-start border border-secondary" style={{backgroundColor: "rgb(214, 213, 213)"}}>
                        <h1>
                            <div class="display-4">Dhivagaran</div>
                        ...
                        <div class="contact">
                            ...
                            <span class="lead"><i class="bi bi-envelope-at-fill"></i> How to reach me : 
                                <a href="mailto:dhivagar2024@gmail.com" class="btn btn-sm btn-primary fw-bold">Email</a>
                            </span>
                            <br /><br />
                            <span class="lead"><i class="bi bi-geo-fill"></i>vellore, Tamil nadu</span>
                            <br /><br />
                            <span class="lead fw-900"><i class="bi bi-at"></i> Connect with me : </span>
                            <p class="btn-group">
                                <a href="http://www.linkedin.com/in/dhivagaran-p-108084252" target="_blank" class="btn btn-sm btn-success fw-bold"><i class="bi bi-linkedin"></i> Linked In</a>
                                <a href="https://github.com/Dhivagar2024" target="_blank" class="btn btn-warning btn-sm fw-bold"><i class="bi bi-github"></i> GitHub</a>
                            </p>
                    ...
                    <div class="col-8 col-lg-4 col-xl-3">
                        <div class="card border-info border-2">
                            ...
                            <div class="card-body text-center py-4">
                                ...
                                <a href="https://github.com/Dhivagar2024?tab=repositories" class="btn btn-outline-danger btn-md mt-3" target="_blank">View</a>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-lg-6">
                        <form action="">
                            ...
                            <div class="mb-4 input-group">
                                ...
                                <input type="text" class="form-control" id="name" placeholder="e.g. your name" required/>
